...
resource "aws_iam_role_policy_attachment" "iam-policy" {
  ...
  policy_arn = "arn:aws:iam::aws:policy/AdministratorAccess"      #arn:aws:iam::aws:policy/AdministratorAccess
}

resource "aws_iam_role_policy_attachment" "ec2_full_access" {
  role       = aws_iam_role.iam-role.name
  policy_arn = "arn:aws:iam::aws:policy/AmazonEC2FullAccess"   #arn:aws:iam::aws:policy/AmazonEC2FullAccess
}
